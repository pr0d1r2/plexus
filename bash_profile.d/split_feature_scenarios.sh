function split_feature_scenarios() {
  ...
  do
    split_feature_scenarios_LINES_REMAINING=`cucumber_scenarios_at_lines $split_feature_scenarios_FEATURE`
    ...
    for split_feature_scenarios_LINE in `cucumber_scenarios_at_lines $split_feature_scenarios_FEATURE`
    do
